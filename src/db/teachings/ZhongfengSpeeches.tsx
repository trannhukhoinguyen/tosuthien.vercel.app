const ZhongfengSpeeches = {
  ...
  paragraph14:
    ...
    'Dầu cho ông ghi nhớ được nhiều, nói được thông thuộc, đối với sanh tử tình vọng của chính mình muốn hoàn toàn quét sạch thì xiết bao xa cách như trời với đất. Hiện nay ở bên bờ sanh tử, mở to đôi mắt giữa ban ngày, đối thanh đối sắc, gặp thuận gặp nghịch, hễ có một niệm khởi diệt càng thấy quét sạch chẳng nổi, mà dẫu cho đối với thị phi thuận nghịch mỗi mỗi đều quét sạch được, cái biết quét sạch ấy cũng là lấy trò đồng bóng làm chủ tể, mà sống theo nhà ma quỷ, có dùng được gì!\n' +
    '\n' +
    'Hiện nay nhiều nơi dạy người tham thiền phần nhiều chỉ tham những loại thiền nầy, chỉ quý thuyết thông, chẳng cầu tâm ngộ. ' +
    'Nếu cái tâm chí linh này chẳng từng hướng lên trên ruộng đất chân thật triệt ngộ một phen, mặc cho ông lấy cái tư chất thông minh hướng vào trong bụng Thích Ca, Đạt Ma cho đến Lâm Tế, Đức Sơn nhất thời chạy qua trăm vòng, ngàn vòng thấy suốt tim phổi, cũng chính là si cuồng chạy ở bên ngoài vậy.\n' +
    '\n' +
    'Người chân thật có chí vì sanh tử, hẳn chẳng chịu đạp bước vào lối mòn nầy. ' +
    'Chỉ nắm lấy một câu thoại đầu sở tham vô nghĩa vô vị đó liền tại trước mắt tương tự như người chết. Duy có một cái tâm chân tham thật cứu, không khởi một chút vọng tưởng muốn hiểu thiền, hiểu đạo. ' +
    ...
    'hay khiến cho người ta mắt thấy hoa đốm giữa hư không, si cuồng chạy bên ngoài, không giúp được gì cả! Ông nếu tham đến trăm năm sau rõ ràng ở dưới thân mình không có chỗ xu hướng, chính là người tốt thanh tịnh bậc nhất. ' +
    ...
    'Hơn 3 năm ở núi, gần đây mới tin được nổi và chẳng bị tri giải làm mê hoặc. Nay khởi niệm nhớ cố hương, lập chí lớn nguyện hết những năm về chiều ra sức tham cứu đến chỗ cùng tận sâu xa để mong chánh ngộ. Ông lại viết thư xin lời cảnh sách, do đó tôi dẫn lời trước để dạy ông. Còn có một câu sau cùng hai tay xin trao gửi:\n' +
    '\n' +
  ...
  paragraph26:
    ...
    'Càng tham chẳng được càng thêm tinh tấn, càng hạ thủ chẳng được càng thêm dũng mãnh. Ông ở chỗ hạ thủ chẳng được, tham chẳng được, chợt sanh một niệm nghi hoặc vọng kiến khởi các thứ tình giải hoặc phàm hoặc thánh v.v...đều rơi vào hầm sanh tử.\n' +
    '\n' +
    'Tham thiền, nếu tham chẳng được chẳng nên nói căn khí chậm lụt, chẳng nên nói nghiệp chướng nặng, chẳng nên nói thời tiết muộn, chẳng nên nói chẳng gặp thiện tri thức. ' +
    'Đại ý chỉ vì một cái chánh niệm vì sanh tử của ông chẳng chân chẳng thiết. Tâm nầy nếu chân thiết, nói gì ba mươi năm, mà ba mươi đời cũng không sợ hãi, cứ mật thiết hướng tới trước tham cứu. Cổ nhân nói:\n' +
    '\n' +
  ...
  paragraph28:
    'Phật pháp toàn thể là ông đầy đủ, ông vừa chợt sanh một niệm muốn nhằm ở trên Phật pháp nắm lấy thì đã rơi vào ý địa, không bao giờ cùng với Phật pháp tương ưng. ' +
    'Ông nếu chân chánh chẳng chịu bỏ qua việc lớn sanh tử, lại chẳng hướng vào lúc một niệm chưa khởi mà gánh vác, chỉ đem câu thoại đầu :"Khi tứ đại tan rã hướng vào chỗ nào an thân lập mạng?". ' +
    'Tùy theo ông bất cứ ở chỗ nào đứng ngồi miên mật tham cứu. ' +
    'Chính đương lúc tham, tất cả những nghĩa lý của Kinh điển và ngữ ngôn, công án trong Thiền Tông từ xưa đến nay đã ghi nhớ được đều chẳng được nhớ nửa chữ trong lòng, cũng chẳng được treo nửa chữ ở bên khoé miệng. ' +
    ...
    'Ông nếu chưa đích thân đến cái thời tiết chánh ngộ nầy mà chỉ muốn đem tâm ý thức hướng lên trên ngữ ngôn tương tợ hoà hội tri giải, dẫu cho ông hiểu được một gánh Thiền đạo Phật pháp, đây gọi là "ăn đàm dãi con chồn", muôn kiếp ông cũng không xong việc.\n' +
    '\n' +
