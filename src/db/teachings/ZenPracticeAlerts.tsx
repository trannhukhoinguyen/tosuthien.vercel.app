const ZenPracticeAlerts = {
  title: 'Tham Thiền Cảnh Ngữ',
  subTitle: 'Việt Dịch: [Thiền sư] Thích Duy Lực',
  ...
  intro:
    ...
    'cần phải gặp người tuyệt khí tức, biết ngứa ngáy mới chịu chẩn bệnh. ' +
  ...
  paragraph2:
    ...
    'Hãy đem một niệm này làm viên ngói gõ cửa, tương tợ như ngồi trong đống lửa lớn muốn cầu thoát ra, đi bậy một bước chẳng được, dừng lại một bước chẳng được, ' +
  ...
  paragraph3:
    'Ngoại-đạo khiến thân tâm đoạn-diệt hóa làm đá cứng cũng từ cảnh tịnh mà vào. Bởi vì lâu ngày chầy tháng không đó lại không, tịch đó lại tịch, ' +
    'rơi vào vô tri cùng với gỗ đá đâu khác. ' +
    'Chúng ta hoặc ở nơi cảnh tịnh chỉ muốn phát minh một đoạn Đại-sự dưới sự y áo (kiến Tánh), chẳng biết ở tại tịnh cảnh mới được, ' +
    'ở trong Đại-sự cầu tướng tịnh ấy trọn chẳng thể được, đây gọi là được vậy (kiến tánh rồi thì động tịnh đều chẳng sanh). ' +
    'Tham-thiền phải ở trong đó mạnh dạn tiến tới, chẳng gần gũi nhân tình. ' +
    'Nếu theo tình ứng đối thì công phu hạ thủ chẳng tiến, chẳng những hạ thủ chẳng tiến mà lâu ngày chầy tháng ắt chắc chắn trở thành ông thầy chạy theo dòng thế tục. ' +
    ...
    'Trong ấy chỉ cần chẳng nên sanh chấp, sanh trước, sanh kế. Chấp thành bệnh, trước thành Ma, kế thành Ngoại-đạo. ' +
  ...
  paragraph6:
    ...
    'Bởi vì tự mình chẳng từng tham-cứu, hoặc lấy Cổ-nhân một hỏi một đáp liền lãnh ngộ bèn đem Thức để hiểu rồi dối gạt người, ' +
    'hoặc gặp một phen bệnh nặng kêu khổ suốt ngày, những điều hiểu biết bình thường đều chẳng dùng được, ' +
    'hoặc đến lúc mạng chung như con cua bị bỏ vào nồi nước sôi tay chân rối loạn, ăn năn đâu kịp. ' +
  ...
  paragraph7:
    ...
    'và đề khởi thoại-đầu chẳng theo cảnh duyên chuyển mới được. Hoặc nói : Chẳng cần kíp. Ba chữ này gây lầm lạc cho người, người học cần phải xét kỹ. ' +
    ...
    'Tham-thiền, nghi-tình chẳng vỡ như đi trên vực sâu, tợ bước trên băng mỏng, mảy may đánh mất Chánh-niệm thì tán thân mất mạng, vì nghi-tình chẳng vỡ, ' +
    'cái lý vĩ đại chưa sáng, một hơi thở ra chẳng hít vào là qua đời khác, bị Trung-ấm kéo dắt không khỏi đi theo nghiệp-thức thay đầu đổi mặt mà chẳng hay chẳng biết. ' +
  ...
  paragraph10:
    ...
    'như người tìm vật bị đánh mất, tìm ra mới thôi. Nếu tìm chẳng ra bèn bỏ vào cái vỏ vô-sự, không có ý tìm nữa thì dẫu cho vật bị đánh mất có hiện tiền cũng lầm qua trước mặt, bởi vì không có ý tìm vật vậy. ' +
    ...
    'Như người hỏi đường đến Trường-an, chỉ có thể hỏi đường, chứ chẳng nên hỏi việc ở Trường-an. Người kia có nói rõ ràng mọi việc ở Trường-an, trọn là cái việc của người kia thấy chứ chẳng phải người hỏi đường đích thân thấy. Nếu chẳng cố gắng tham-cứu mà cầu người nói trắng ra, cũng giống như vậy. ' +
    'Tham-thiền chẳng phải niệm Công-án, niệm tới niệm lui có gì dính dáng, niệm đến lúc ngài Di-lặc hạ sanh cũng không dính dáng, sao chẳng niệm A-di-đà Phật còn có lợi ích hơn. Chẳng những bảo chẳng cần niệm mà phải luôn luôn đề khởi thoại-đầu, như khán chữ Vô thì ở trên chữ vô khởi nghi-tình, như khán Cây bách thì ở trên cây bách khởi nghi-tình, như khán Một qui về chỗ nào ? thì ở trên qui về chỗ nào khởi nghi-tình. nghi-tình phát khởi thì tận mười phương thế giới là một khối nghi, chẳng biết có thân tâm cha mẹ sanh. Toàn thân là một khối nghi, chẳng biết có mười phương thế giới, chẳng phải trong chẳng phải ngoài, đập lại thành một khối; chỉ đợi khối nghi kia tự vỡ như thùng đứt dây đay, gặp Thiện-tri-thức, chẳng đợi mở miệng; Đại-sự xong xuôi mới vỗ tay cười lớn; nhìn lại sự niệm Công-án thật giống như chim Anh-vũ học nói, nào có dính dáng gì đến Đại-sự ?. ' +
...
export default ZenPracticeAlerts
