const sectDb = [
  ...
  },
  {
    ...
    description: 'Yangqi',
    place: 'Putong Temple (普通寺; Pǔtōng Sì) is a Buddhist temple located on Mount Yangqi in Shangli County, Jiangxi, China. ' +
      'It is the cradle of the Yangqi sect of Linji school',
    relation: 'Linji',
    doctrine: '',
    reference: ['',
      'https://zh.wikipedia.org/wiki/%E6%9D%A8%E5%B2%90%E5%AE%97', 'https://vi.wikipedia.org/wiki/D%C6%B0%C6%A1ng_K%C3%AC_ph%C3%A1i',
      'https://en.wikipedia.org/wiki/Putong_Temple'
    ],
  },
  {
    id: 7,
