const CongRongLu = [
  ...
  },
  {
    ...
    commentBefore:
      '    Sư nói: Bát-nhã Đa-la từng dặn cho Đạt Ma Đại Sư rằng: Sau khi ta diệt độ, 5 ông nên đến nước Chấn Đán bày ra Đại Pháp chỉ thẳng cho bậc thượng căn, cẩn thận nhanh chóng gặp nạn nên dừng ở Lạc Dương.\n' +
    ...
    verseTranslated:  '',
    commentAfter:
      '    Sư nói: “___Rỗng rang không Thánh, căn cơ xa tít___”.' +
...
postGroup: 0,
    ...
    main:
      ...
      '    Đồng Tử đáp: Tôi nhớ xưa kia cùng sống với Sư, Sư giảng Ma Ha Bát Nhã, con thì thọ trì kinh điển sâu xa, cùng thay nhau giáo hóa, nên đợi Sư ở đây. ' +
      'Tổ nói với vua rằng: Đây không phải tiểu Thánh mà là ứng thân của Đại Thế Chí, vua mời lên xe đến cung điện cúng dường, cho đến mặc áo nhuộm. ' +
    ...
    commentAfter:
      'Sư nói: 2 câu phá đề, bài Tụng không ở cõi âm, không theo các chuyển lại Tạng giáo Pháp số, có 5 ấm, 12 xứ, 1 giới, phân làm 3 khoa, Tôn giả lược nêu đầu đuôi, tóm thâu trong đó.\n' +
      '\n' +
