...
'Lúc đó sẽ thoát khỏi mê lầm của vòng luân hồi, có thể rong chơi trong cõi trời đất. Khi tự giác được cái tôi vô ngã, vô tướng (vô vị chân nhân) là đã thấy được Phật tính của mình (kiến tính) vậy.',
  },
  {
    ...
    image: '/images/gateless-gate/gateless-gate-cover.jpg',
    main:
'Cứ mỗi khi hòa thượng Bách Trượng thuyết pháp, thường có một lão già đi sau tăng chúng đến nghe. Khi các thiền sinh rút lui, lão cũng bước ra theo. Thế rồi một hôm, lão bỗng không lui mà nán lại giảng đường.Lúc đó, Bách Trượng mới hỏi: ' +
'Người đứng trước mặt ta, ông là ai vậy? Lão già thưa: ' +
Tôi không phải loài người. Xửa xưa, thời Phật Ca Diếp, tôi đã trụ trì ở núi này. Một hôm, đệ tử có người hỏi rằng người tu hành đạo Phật đến chỗ cao diệu vẫn còn có thể sa vào vòng nhân quả khổ đau hay không. ' +
Tôi mới trả lời là không, người như thế không sa vào vòng nhân quả. Vì nói vậy mà suốt một thời gian dài tôi sa vào súc sinh đạo, bị đọa làm thân chồn hoang, cho đến nay đã trải qua năm trăm kiếp. ' +
...
'Đại đệ tử là Hoàng Bá nhân đó mới hỏi: Ngày xưa, lão già vì trả lời sai một câu hỏi mà bị đọa làm thân chồn hoang suốt năm trăm kiếp, nếu lão ta trả lời đúng thì liệu lão sẽ trở thành gì ạ? ' +
