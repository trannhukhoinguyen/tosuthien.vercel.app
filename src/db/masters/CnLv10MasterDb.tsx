const CnLv10MasterDb = [
  {
    ...
    name_vi: 'Phần Dương Thiện Chiêu (Chiếu)',
  ...
  },
  {
    id: '43.10.7',
    hasContent: 'true',
    name_en: 'Dayang Jingxuan (Taiyang)',
    name_es: 'Dayang Jingxuan',
    name_de: 'Dayang Jingxuan',
    name_fr: 'Dayang Jingxuan',
    name_vi: 'Đại Dương Kỉnh Huyền (Thái Dương Cảnh Huyền)',
  ...
  },
{
    id: '43.10.8',
    hasContent: 'true',
    name_en: 'Sanjiao Zhisong (Tang Ming)',
  ...
  },
  {
    ...
    image: '/images/square/meta-image-square-1.jpg',
    reference: ['https://blog.phapthihoi.org/gt-member/0-ts-lac-dam-hoai-trung/', 'https://tuvienquangduc.com.au/Thien/124thienluan2-1a.html'],
  },
]
