  ...
  },
{
    id: '43.10.8',
    hasContent: 'true',
    name_en: 'Tiefo Zhisong',
    name_es: 'Tiefo Zhisong',
    name_de: 'Tiefo Zhisong',
    name_fr: 'Tiefo Zhisong',
    name_vi: 'Thừa Thiên Trí Tung',
    name_ru: 'Tiefo Zhisong',
    name_zh: '承天智嵩',
    name_ja: 'Tiefo Zhisong',
    name_ko: 'Tiefo Zhisong',
    name_ar: 'Tiefo Zhisong',
    birth_death_time: ['', ''],
    records: '',
    sect: ['Linji'],
    country: 'China',
