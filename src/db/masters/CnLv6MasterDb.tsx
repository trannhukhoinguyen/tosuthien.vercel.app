...
worship_tower: 'Phúc Viên',
    ...
    successors: ['Trung Tào Sơn Huệ Hà (中曹山慧霞)'],
    disciples: ['Trung Tào Sơn Huệ Hà (中曹山慧霞), Kim Phong Tùng Chí (金峰從志), Lộc Môn Xử Chơn (鹿門處眞), Hà Ngọc Quang Tuệ (荷玉光慧), Dục Vương Hoằng Thông (育王弘通)'],
  ...
  },
  {
    ...
    name_vi: 'Hưng Hóa Tồn Tương / Hưng Hóa Tồn Tưởng',
