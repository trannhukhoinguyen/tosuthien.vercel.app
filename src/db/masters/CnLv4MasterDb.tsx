const CnLv4MasterDb = [
  ...
  },
  {
    ...
    teachers: ['Chii (智威)'],
    successors: [''],
    disciples: ['Duy Tắc Phật Quật', 'Thái Bạch Quán Tông', 'Kim Lăng Huệ Thiệp'],
    image: '/images/avatar.png',
    reference: [''],
  },
  {
    ...
    teachers: ['Chii (智威)'],
    successors: [''],
    disciples: ['Kinzan Dōkin (徑山道欽) - Kính Sơn Đạo Khâm', 'Ngô Trung Pháp Kính', 'Wuxing Fahai - Ngô Hưng Pháp Hải', 'Tử Sơn Hạo Nhiên'],
    image: '/images/avatar.png',
    reference: [''],
  },
  {
