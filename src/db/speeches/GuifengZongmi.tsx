...
{
    id: 385101,
    authorName: 'Khuê Phong Tông Mật',
    authorImage: '/images/wide/cloudy-mountain-peak.jpg',
    authorLink: '/masters/Guifeng-Zongmi',
    speechMain:
      ...
      '[TẠM DỊCH] / ' +
      'Làm chuyện nghĩa lý là tâm tỉnh ngộ / ' +
      'Làm chuyện vô nghĩa là tâm loạn cuồng / ' +
      'Cuồng loạn do tình niệm / ' +
      'Lâm chung bị nghiệp lôi / ' +
      'Tỉnh ngộ không do tình / ' +
      'Lâm chung chuyển được nghiệp.',
    speechType: '',
  },
];

export default GuifengZongmi;
