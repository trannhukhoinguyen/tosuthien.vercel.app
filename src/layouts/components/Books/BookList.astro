            ...
            <div class='flex-column group'>
              ...
              <div class='bottom'>
                ...
                }
                {
                  book.linkAudio
                    ? <button class='simple'>
                      <a href={book.linkAudio} target="_blank" title="Audios">📼</a>
                    </button>
                    : ''
                }
                {
                  book.linkAudio1
                    ? <button class='simple'>
                      <a href={book.linkAudio1} target="_blank" title="Audios P1">📼 1</a>
                    </button>
                    : ''
                }
                {
                  book.linkAudio2
                    ? <button class='simple'>
                      <a href={book.linkAudio2} target="_blank" title="Audios P2">📼 2</a>
                    </button>
                    : ''
                }
                {
                  book.saveAudio
                    ? <button class='simple'>
                        <a href={ book.saveAudio } download="" title="Download Audio">⇩ Audio</a>
                      </button>
                    : ''
                }
              </div>
