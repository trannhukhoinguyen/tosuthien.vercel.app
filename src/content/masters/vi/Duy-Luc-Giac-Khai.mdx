...
<div className="grid xl:grid-cols-8 lg:grid-cols-7 md:grid-cols-2 sm:grid-cols-2 xs:grid-cols-1 gap-8 bg-body dark:bg-darkmode-body">
...
<div className="lg:col-span-3">
    ...
    <Notice type="warning" title="hỏi đáp">
      ...
      <Indent/><a href="/faqs/responses-from-venerable-duy-luc" target="_blank">DUY LỰC NGỮ LỤC</a>
