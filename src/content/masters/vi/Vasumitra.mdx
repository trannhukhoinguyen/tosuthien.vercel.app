...
<div className="grid xl:grid-cols-7 lg:grid-cols-7 md:grid-cols-2 sm:grid-cols-2 xs:grid-cols-1 gap-8 bg-body dark:bg-darkmode-body">
  ...
  <div className="lg:col-span-2 md:col-span-1">
    ...
    <Indent/>Tổ truyền pháp thứ bảy của Thiền Tông Ấn Độ, Bà Tu Mật hay Phiệt Tô Mật Đát La là tên của một vị Bồ Tát ra đời 400 năm sau ngày Phật nhập diệt, cư dân vùng Bắc Ấn, dòng họ Phả La Đọa, sanh ra vào cuối thế kỷ thứ nhất sau Tây lịch.
