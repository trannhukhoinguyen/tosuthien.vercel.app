...
<div className="grid xl:grid-cols-8 lg:grid-cols-8 md:grid-cols-2 sm:grid-cols-2 xs:grid-cols-1 gap-8 bg-body dark:bg-darkmode-body">
  ...
  <div className="lg:col-span-3 md:col-span-1">
    ...
    Thiền sư __Hưng Hóa Tồn Tương__ (830-925), thuộc dòng dõi họ Khổng, một dòng họ danh giá của Trung Hoa. Năm 2005 được bằng kỷ lục là có ghi nhận bộ gia phả của dòng họ Khổng là gia phả lâu đời nhất, trên 2,500 năm, với chi tiết đầy đủ của 86 thế hệ.
