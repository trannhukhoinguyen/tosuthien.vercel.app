          ...
          <div class="flex justify-between items-start">
            <div id={rec.anchor}>
              ...
              <div class="flex items-center mt-1">
                <span class="text-xs text-gray-500 ml-1">{rec.content}</span>
              </div>
            </div>
          </div>
...
{/*
  <div class="rounded-xl shadow-sm border border-gray-100 p-4 hover:border-blue-500 transition-all duration-200">
    <div class="flex items-center gap-3">
      <div class="flex-1">
        <div class="flex justify-between items-start">
          <div id="Nanyue_Huairang">
            <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
              <img class="rounded-circle" src="/images/avatar-sm.png" />
            </div>
            <h3 class="text-lg font-medium text-gray-900 title"><a href="/masters/nanyue-huairang">TS. HOÀI NHƯỢNG - Nam Nhạc</a></h3>
            <div class="flex items-center mt-1">
      ...
      <div class="flex-1">
        <div class="flex justify-between items-start">
          <div id="Fayan_Wenyi">
            ...
            <h3 class="text-lg font-medium text-gray-900 title"><a href="/masters/fayan-wenyi">TS. VĂN ÍCH - núi Thanh Lương</a></h3>
            <div class="flex items-center mt-1">
              <span class="text-xs text-gray-500 ml-1">
      ...
      <div class="flex-1">
        <div class="flex justify-between items-start">
          <div id="Linji_Yixuan">
            ...
            <h3 class="text-lg font-medium text-gray-900 title"><a href="/masters/linji-yixuan">TS. NGHĨA HUYỀN - viện Lâm Tế</a></h3>
            <div class="flex items-center mt-1">
              <span class="text-xs text-gray-500 ml-1">
  ...
  <div class="rounded-xl shadow-sm border border-gray-100 p-4 hover:border-blue-500 transition-all duration-200">
    <div class="flex items-center gap-3">
      <div class="flex-1">
        <div class="flex justify-between items-start">
          <div id="Zhaozhou_Congshen">
            <div class="w-10 h-10 bg-yellow-100 rounded-full flex items-center justify-center">
              <img class="rounded-circle" src="/images/avatar-sm.png" />
            </div>
            <h3 class="text-lg font-medium text-gray-900 title"><a href="/masters/zhaozhou-congshen">TS. TÙNG THẨM - viện Quan Âm</a></h3>
            <div class="flex items-center mt-1">
              <span class="text-xs text-gray-500 ml-1">
          Sư thượng đường nói:
      ...
      <div class="flex-1">
        <div class="flex justify-between items-start">
          <div id="">
            ...
            <h3 class="text-lg font-medium text-gray-900 title"><a href="/masters/fayan-wenyi">TS. </a></h3>
            <div class="flex items-center mt-1">
              <span class="text-xs text-gray-500 ml-1">
        ...
        <div class="flex items-center gap-2 mt-2">
          <span class="inline-flex items-center gap-1 bg-purple-50 text-purple-700 text-xs font-medium px-2.5 py-0.5 rounded-full">
            <span class="m-2">---</span>
          </span>
        </div>
      </div>
      ...
      <div class="flex-1">
        <div class="flex justify-between items-start">
          <div id="">
            ...
            <h3 class="text-lg font-medium text-gray-900 title"><a href="/masters/linji-yixuan">TS. </a></h3>
            <div class="flex items-center mt-1">
              <span class="text-xs text-gray-500 ml-1">
        ...
        <div class="flex items-center gap-2 mt-2">
          <span class="inline-flex items-center gap-1 bg-pink-50 text-pink-700 text-xs font-medium px-2.5 py-0.5 rounded-full">
            <span class="m-2">---</span>
          </span>
        </div>
      </div>
